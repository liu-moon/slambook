...
: ${AMENT_CURRENT_PREFIX:="/home/liuiu/桌面/slambook/src/install/ch2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ch2/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ch2/environment/path.sh"
