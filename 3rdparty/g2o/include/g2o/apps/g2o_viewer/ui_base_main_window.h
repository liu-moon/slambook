...
#if QT_CONFIG(tooltip)
        btnOptimizerParamaters->setToolTip(QCoreApplication::translate("BaseMainWindow", "Adjust the parameters of the optimizer", nullptr));
#endif // QT_CONFIG(tooltip)
        btnOptimizerParamaters->setText(QCoreApplication::translate("BaseMainWindow", "Parameters", nullptr));
